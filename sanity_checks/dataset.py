...
class RAPN_Dataset(BaseDataset):
    ...
    def __getitem__(self, i):
        ...
        rel_path = self.images[i].split('/')[-1]
        procedure = rel_path[:-9]
        n_image = rel_path[-8:-4]
        ...
        return image, mask, procedure, n_image
...
for i in range(38):
    image, mask, p, n = dataset.__getitem__(i)
#image, mask, p, n = dataset.__getitem__(10)
