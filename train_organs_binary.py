...
def main():
    ...
    test_logs, test_iou, test_dice = valid_epoch.run(valid_loader)
    IoU, inference_time, FBetaScore, DiceScore = saveResults(valid_loader, model, len(classes), PLATFORM, ENCODER,
